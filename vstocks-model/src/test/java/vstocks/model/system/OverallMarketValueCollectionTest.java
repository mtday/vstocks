...
public class OverallMarketValueCollectionTest {
    ...
    public void testGettersAndSetters() {
        OverallMarketValueCollection collection = new OverallMarketValueCollection().setValues(values).setDeltas(deltas);
    ...
    public void testEquals() {
        OverallMarketValueCollection collection1 = new OverallMarketValueCollection().setValues(values).setDeltas(deltas);
        OverallMarketValueCollection collection2 = new OverallMarketValueCollection().setValues(values).setDeltas(deltas);
    ...
    public void testToString() {
        OverallMarketValueCollection collection = new OverallMarketValueCollection().setValues(values).setDeltas(deltas);
        assertEquals("OverallMarketValueCollection{values=" + values + ", deltas=" + deltas + "}",
                collection.toString());
    }
}
