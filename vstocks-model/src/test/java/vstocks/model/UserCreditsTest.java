...
public class UserCreditsTest {
    ...
    public void testGettersAndSetters() {
        ...
        assertEquals(0, UserCredits.FULL_COMPARATOR.compare(userCredits, userCredits));
        assertEquals(0, UserCredits.UNIQUE_COMPARATOR.compare(userCredits, userCredits));
    }
