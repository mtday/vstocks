...
public class OverallMarketTotalValueServiceImplIT extends BaseServiceImplIT {
    private UserService userService;
    private StockService stockService;
    private StockPriceService stockPriceService;
    private UserStockService userStockService;
    private OverallMarketTotalValueService overallMarketTotalValueService;
    ...
    public void setup() {
        ...
        overallMarketTotalValueService = new OverallMarketTotalValueServiceImpl(dataSourceExternalResource.get());
    ...
    @After
    public void cleanup() {
        overallMarketTotalValueService.truncate();
    ...
    public void testGetLatestSome() {
        assertEquals(1, overallMarketTotalValueService.add(overallMarketTotalValue1));
        assertEquals(1, overallMarketTotalValueService.add(overallMarketTotalValue2));
    ...
    public void testGetAllSome() {
        ...
        Results<OverallMarketTotalValue> results = overallMarketTotalValueService.getAll(new Page(), emptyList());
        validateResults(results, overallMarketTotalValue1, overallMarketTotalValue2);
    }
    ...
    public void testGetAllSomeSort() {
        ...
        Results<OverallMarketTotalValue> results = overallMarketTotalValueService.getAll(new Page(), sort);
        validateResults(results, overallMarketTotalValue2, overallMarketTotalValue1);
    }

    @Test(expected = Exception.class)
    public void testAddConflict() {
        assertEquals(1, overallMarketTotalValueService.add(overallMarketTotalValue1));
        overallMarketTotalValueService.add(overallMarketTotalValue1);
    }
    ...
    public void testAgeOff() {
        ...
        assertEquals(1, overallMarketTotalValueService.ageOff(now.minusSeconds(5)));

        Results<OverallMarketTotalValue> results = overallMarketTotalValueService.getAll(new Page(), emptyList());
        validateResults(results, overallMarketTotalValue1);
    }
    ...
    public void testTruncate() {
        ...
        assertEquals(2, overallMarketTotalValueService.truncate());
