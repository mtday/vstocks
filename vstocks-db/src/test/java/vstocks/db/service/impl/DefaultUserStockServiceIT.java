...
public class DefaultUserStockServiceIT {
    @ClassRule
    ...
    private JdbcUserBalanceStore userBalanceStore;
    private JdbcUserStockStore userStockStore;
    private DefaultUserStockService userStockService;
    ...
    public void setup() throws SQLException {
        ...
        userBalanceStore = new JdbcUserBalanceStore();
        userStockStore = new JdbcUserStockStore();
        userStockService = new DefaultUserStockService(dataSourceExternalResource.get(),
                userStockStore, userBalanceStore, stockPriceStore, activityLogStore);
