...
import vstocks.db.store.impl.JdbcUserBalanceStore;
...
public class DefaultUserBalanceServiceIT {
    ...
    public void setup() throws SQLException {
        ...
        userBalanceService = new DefaultUserBalanceService(dataSourceExternalResource.get(), userBalanceStore);
