...
public class MarketTotalValueServiceImplIT extends BaseServiceImplIT {
    private UserService userService;
    private StockService stockService;
    private StockPriceService stockPriceService;
    private UserStockService userStockService;
    private MarketTotalValueService marketTotalValueService;
    ...
    public void setup() {
        ...
        marketTotalValueService = new MarketTotalValueServiceImpl(dataSourceExternalResource.get());
    ...
    public void testGetLatestNone() {
        MarketTotalValueCollection latest = marketTotalValueService.getLatest(user1.getId());
    ...
    public void testGetLatestSome() {
        ...
        MarketTotalValueCollection latest = marketTotalValueService.getLatest(user1.getId());
        validateResults(latest.getValues(), marketTotalValue11, marketTotalValue12);
    ...
    public void testAddConflict() {
        assertEquals(1, marketTotalValueService.add(marketTotalValue11));
        assertEquals(0, marketTotalValueService.add(marketTotalValue11));
    }
