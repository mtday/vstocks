...
public class PortfolioValueRankTable extends BaseTable {
    ...
    public PortfolioValueRankCollection getLatest(Connection connection, String userId) {
        ...
        return new PortfolioValueRankCollection()
                .setRanks(ranks)
                // We stick a "-" on the rank since lower ranks should be seen as positive deltas
                .setDeltas(Delta.getDeltas(ranks, PortfolioValueRank::getTimestamp, r -> -r.getRank()));
    }
