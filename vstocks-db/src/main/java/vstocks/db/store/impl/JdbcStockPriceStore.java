...
public class JdbcStockPriceStore extends BaseStore<StockPrice> implements StockPriceStore {
    ...
    private static final RowSetter<StockPrice> INSERT_ROW_SETTER = (ps, stockPrice) -> {
        ...
        ps.setString(++index, stockPrice.getMarketId());
    ...
    public int add(Connection connection, StockPrice stockPrice) {
        String sql = "INSERT INTO stock_prices (id, market_id, stock_id, timestamp, price) VALUES (?, ?, ?, ?, ?)";
