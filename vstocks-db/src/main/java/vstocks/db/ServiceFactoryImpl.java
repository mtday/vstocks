...
public class ServiceFactoryImpl implements ServiceFactory {
    ...
    private final StockActivityLogService stockActivityLogService;
    ...
    private final PortfolioValueSummaryService portfolioValueSummaryService;
    ...
    public ServiceFactoryImpl(DataSource dataSource) {
        ...
        this.stockActivityLogService = new StockActivityLogServiceImpl(dataSource);
        ...
        this.portfolioValueSummaryService = new PortfolioValueSummaryServiceImpl(dataSource);
    ...
    @Override
    public StockActivityLogService getStockActivityLogService() {
        return stockActivityLogService;
    }
    ...
    @Override
    public PortfolioValueSummaryService getPortfolioValueSummaryService() {
        return portfolioValueSummaryService;
    }
