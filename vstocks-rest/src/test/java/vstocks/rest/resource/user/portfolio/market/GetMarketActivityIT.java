...
public class GetMarketActivityIT extends ResourceTest {
    ...
    public void testUserPortfolioMarketActivityPageAndSort() {
        ...
        when(stockActivityLogService.getForUser(eq(getUser().getId()), eq(TWITTER), any(), eq(page), eq(sort))).thenReturn(results);
    ...
    public void testUserPortfolioMarketActivityWithData() {
        ...
        StockActivityLog activityLog = new StockActivityLog()
                .setId("id")
        ...
        StockActivityLogService stockActivityLogService = mock(StockActivityLogService.class);
        when(stockActivityLogService.getForUser(eq(getUser().getId()), eq(TWITTER), any(), any(), any())).thenReturn(results);
        when(getServiceFactory().getStockActivityLogService()).thenReturn(stockActivityLogService);
