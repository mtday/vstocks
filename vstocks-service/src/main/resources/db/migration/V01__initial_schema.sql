...
CREATE TABLE stock_prices (
    ...
    CONSTRAINT stock_prices_unique UNIQUE (market, stock_id, timestamp),
...
CREATE TABLE activity_logs (
    ...
    CONSTRAINT activity_logs_unique UNIQUE (user_id, market, stock_id, timestamp),
...
CREATE TABLE user_stocks (
    ...
    CONSTRAINT user_stocks_pk PRIMARY KEY (user_id, market, stock_id),
